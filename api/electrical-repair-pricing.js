// /api/electrical-repair-pricing - reads Globals from Airtable for the
// electrical repair calculator. Currently just reads a single-row config table.

const AIRTABLE_API_KEY = process.env.AIRTABLE_API_KEY;
const AIRTABLE_BASE_ID = process.env.AIRTABLE_BASE_ID;
const GLOBALS_TABLE = 'Repair - Electrical Globals';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('Electrical repair pricing error:', err);
